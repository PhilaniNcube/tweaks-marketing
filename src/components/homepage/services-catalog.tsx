...
const products = [
  {
    ...
    description:
      "Deep structural, stylistic, and grammatical polishing for theses and dissertations.",
  },
  {
    ...
    description:
      "Prepare your paper for international, peer-reviewed journal submission.",
  },
  {
    ...
    description:
      "Verify in-text citations against your reference list for consistency.",
  },
  {
    name: "Formatting",
    price: "R1,500.00",
    ...
    description:
      "Align margins, fonts, and headings to APA, Harvard, or university guidelines.",
  },
  {
    ...
    description:
      "Clean up and standardize your reference list entries to a chosen style guide.",
  },
  {
    ...
    description:
      "Refining abstract summaries to ensure impact and conciseness for readers.",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-zinc-400 font-light text-base leading-relaxed">
            Browse the list below to learn more about each of our academic
            editing services. Each description outlines what’s included, who
            it’s for, and how it can support your academic goals.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex items-center text-indigo-500 hint-nudge">
                ...
                <div className="p-6 flex flex-col justify-between flex-1 text-left space-y-4">
                  ...
                  <div className="pt-2">
                    <Button
                      asChild
                      variant="outline"
                      className="w-full justify-between font-semibold border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 dark:hover:bg-indigo-600 dark:hover:text-white transition-all cursor-pointer rounded-none"
                    >
                      <a
                        href={product.href}
