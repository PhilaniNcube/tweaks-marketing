...
const faqData = [
  ...
  },
  {
    ...
    items: [
      {
        id: "p1",
        question: "Your prices appear to be more expensive than those of another website I have found. Why should I use you?",
        answer: "Our service may appear more expensive; however, choosing the highest-quality and most professional service available ensures that you get the job done right the first time, saving you time and money in the long run. Choosing Tweaks Academic Editing Services ensures that your final document will be as polished and sophisticated as possible, giving you the best chance of publication or thesis acceptance. We are confident that our service is of exceptional value for money. Further, by paying our editors at a higher rate, we are able to attract and retain the most qualified and experienced academic editors in the business, guaranteeing that our clients receive high-quality work."
      },
      {
        id: "p2",
        question: "What payment methods do you accept?",
        answer: "You can purchase any of our academic editing services online using a credit or debit card."
      }
    ]
  },
  {
    ...
    items: [
      {
        id: "g1",
        question: "What happens if I am not happy with the quality of the academic edit?",
      ...
      {
        id: "g2",
        question: "What happens if I make changes to my edited document? Will you check it again for free?",
        answer: "If you make any changes or additions to your edited document and would like us to edit those changes and additions, we need to charge for that as new work. If you only want some clarification about our edits, or if you have found some errors in our work that require revision, we can do this FREE of charge, provided this is within the scope of the original job. This work is covered under our Quality Guarantee."
      }
    ]
  },
  {
    ...
    items: [
      {
        id: "r1",
        question: "Will you crosscheck my in-text references, footnotes or endnotes and reference list or bibliography?",
        answer: "Yes. If you require us to edit your reference list or bibliography, we will crosscheck your reference list or bibliography with your in-text citations, footnotes or endnotes to ensure that each citation corresponds to a referenced source, and vice versa. We will edit your references to ensure that they are correct, consistent and complete, including locating and including missing source information where possible."
      },
      {
        id: "r2",
        question: "Can you follow the guidelines from my university or journal regarding referencing?",
        answer: "Yes, definitely. We can follow any guidelines or style guide that you require. All our editors have a thorough knowledge of different referencing styles, enabling them to follow any required style accurately."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "NO! University academic integrity and plagiarism policies strictly prohibit students from having anyone else perform their work for them. We can certainly help you by editing your work and providing specific feedback to you on how you can further improve your academic writing skills."
      }
    ]
  },
  {
            ...
            >
              ...
              <Accordion className="w-full">
                {categoryGroup.items.map((item) => (
                  <AccordionItem key={item.id} value={item.id} className="border-b border-slate-100 dark:border-zinc-800/60 last:border-0">
