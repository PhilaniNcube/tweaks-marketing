        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          >
            <p className="text-slate-700 dark:text-zinc-300 font-light leading-relaxed text-base">
              ...
              with confidence. Whether you&apos;re preparing a thesis,
              dissertation, research paper, or academic report, our expert
              academic editors ensure your writing is clear, well-structured,
              and ready for submission, with tracked changes and reliable
              on-time delivery.
            </p>
            <div className="pt-6">
              <Button
