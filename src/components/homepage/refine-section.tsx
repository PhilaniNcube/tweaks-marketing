    ...
    <section className="py-20 bg-white dark:bg-zinc-900 border-t border-slate-100 dark:border-zinc-800/40">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          >
            You’ve Done the Work — Now Let Us Refine It
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="flex flex-col justify-center p-6 bg-slate-50 dark:bg-zinc-950/40 rounded-2xl border border-slate-100 dark:border-zinc-800/50"
          >
            <p className="text-slate-700 dark:text-zinc-300 font-light leading-relaxed text-base">
              You’ve done the hard work: gathered your research, shaped your argument, and put your ideas down on paper. Now you want the confidence to share your work, free from errors or awkward phrasing.
            </p>
          </motion.div>
          ...
          >
            <p className="text-slate-700 dark:text-zinc-300 font-light leading-relaxed text-base">
              That’s where we come in. Tweaks offers professional academic editing to help you polish your document and reduce your stress. Our expert editors ensure your writing is clear, structured, and ready for submission — with tracked changes and on-time delivery.
            </p>
            <div className="pt-6">
              <Button asChild className="w-full bg-tweaks-red hover:bg-tweaks-blue text-white font-semibold cursor-pointer shadow-sm rounded-xl py-5">
