...
const faqs = [
  {
    question:
      "Do you build reference lists from scratch if I only have footnotes?",
    answer:
      "Yes, we can compile a clean, unified reference list or bibliography page at the end of your document from your notes, annotations, or inline mentions.",
  },
  {
    question: "Which style guides are supported?",
    answer:
      "We support APA 7th, Harvard, Chicago Notes-Bibliography, Chicago Author-Date, Vancouver, MLA 9th, IEEE, AMA, and specialized medicine/social science templates.",
  },
  {
    question: "Can I submit my reference list as a separate document?",
    answer:
      "Yes, you can submit just your references for standalone formatting and verification if you do not want your main paper edited.",
  },
];
...
const relatedServices = [
  ...
  },
  {
    ...
    price: "R 7.50 / page",
    description:
      "Cross-verify in-text citations against your bibliography and validate sources.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="relative aspect-square w-full border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-900 overflow-hidden rounded-none shadow-sm">
                <Image
                  src="https://conceptafrika.com/wp-content/uploads/2021/09/reference-list-editing.jpg"
                  alt="Reference List Editing Service - Tweaks Academic"
                  fill
                  priority
            ...
            <div className="lg:col-span-6 text-left space-y-6">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-1 text-xs font-bold text-tweaks-blue uppercase tracking-wider">
                  ...
                  <span>Bibliography Formatting</span>
                </div>
              ...
              <div className="border-t border-slate-100 dark:border-zinc-800/80 pt-6">
                <p className="text-base text-slate-600 dark:text-zinc-300 font-light leading-relaxed">
                  We edit your reference list ensuring the correct format is
                  used for various sources, i.e. journals, books, online
                  publications, reports etc. according to your referencing
                  guide.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {[
                    "Correct format per source type (journal, book, report)",
                    "Alphabetize bibliography sequences",
                    "Standardize capitalization of journal titles",
                    "Validate publisher locations and years",
                    "Retrieve missing metadata (volume, issue, pages)",
                    "Format DOIs as live hyperlinks",
                  ].map((item) => (
                    <li
                      key={item}
              ...
              <div className="border border-slate-200 dark:border-zinc-800 p-6 bg-slate-50/50 dark:bg-zinc-900/30 rounded-none space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500 dark:text-zinc-400 font-light">
                    Adjust the number of pages in your reference list and the
                    delivery speed below to estimate editing costs.
                  </p>
                </div>

                {/* Reference List Page Count input */}
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm font-semibold">
                    <label htmlFor="reflist-pages-count">
                ...
                <div className="flex gap-2.5 p-3.5 bg-amber-50 dark:bg-amber-950/20 border-l-4 border-amber-500 text-xs text-amber-800 dark:text-amber-300 rounded-none text-left">
                  ...
                  <p className="font-light leading-relaxed">
                    ...
                    pages in your reference list. If you purchase fewer items
                    than the number of pages in your reference list, your
                    reference list will only be edited to correspond to the
                    number of items you purchased.
                  </p>
                </div>
                ...
                >
                  <Link
                    href={`/contact?service=reference-list-editing&pages=${pages}&speed=${deliverySpeed}`}
                  >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="py-8 text-left">
            {activeTab === "overview" && (
              ...
              >
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">
                  Reference List Editing Details
                </h3>
                ...
                <p className="text-sm font-light text-slate-600 dark:text-zinc-300 leading-relaxed">
                  Reference List Editing is billed at R50.00 per page of your
                  reference list. We support APA 7th, Harvard, Chicago,
                  Vancouver, MLA 9th, IEEE, AMA, and specialized medicine /
            ...
            {activeTab === "support" && (
              ...
              >
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">
                  Bibliography & Reference Corrections
                </h3>
                <p className="text-sm font-light text-slate-600 dark:text-zinc-300 leading-relaxed">
                  We fix errors that computerized citation generators routinely
                  miss. Our editors handle every aspect of reference list
                  standardization.
                </p>
                <ul className="space-y-3">
                  {[
                    {
                      icon: RefreshCw,
                      title: "Bibliography Standardisation",
                      desc: "We edit every reference entry to conform to your specified guide, checking fonts, italics, spacing, indentations, and parentheses.",
                    },
                    {
                      icon: FileText,
                      title: "Missing Metadata Retrieval",
                      desc: "If a citation lacks volume, issue, page number, or publisher information, we investigate online resources to fill in the blanks.",
                    },
                    {
                      icon: Globe,
                      title: "DOI & Electronic Link Audits",
                      desc: "Validate that DOIs and database URLs resolve correctly, formatting them according to updated style definitions.",
                    },
            ...
            {activeTab === "delivery" && (
              ...
              >
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">
                  Reconstruct Corrupted References
                </h3>
                <p className="text-sm font-light text-slate-600 dark:text-zinc-300 leading-relaxed">
                  Exporting citations from tools like Mendeley, Zotero, or
                  EndNote often introduces syntax errors, broken titles, or
                  missing publisher locations. Our human editors carefully proof
                  and verify every bibliography record to restore integrity.
                </p>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {[
                    "Alphabetizing bibliography sequences",
                    "Standardizing capitalization of journal titles",
                    "Validating book publisher locations",
                    "Formatting DOIs as live hyperlinks",
                  ].map((item) => (
                    <li
                      key={item}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-xs font-bold text-slate-600 dark:text-zinc-400 rounded-none">
              ...
              <span>Reference List Editing FAQ</span>
            </div>
